...
class _GameOverScreenState extends State<GameOverScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() =>
          _isNewBest = widget.score > 0 && widget.score >= settings.bestScore);
    });
  }
      ...
      body: Stack(children: [
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => CustomPaint(
              size: size, painter: _GameOverBgPainter(_bgCtrl.value)),
        ),
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: AppTheme.coinColor.o(0.6), width: 1.5),
                        ...
                        child: const Row(
                            ...
                            children: [
                              Icon(Icons.play_circle_outline,
                                  color: AppTheme.coinColor, size: 20),
                              SizedBox(width: 10),
                              Text('WATCH AD — CONTINUE MISSION',
                                  style: TextStyle(
                                    color: AppTheme.coinColor,
                                    fontWeight: FontWeight.w900,
                                    letterSpacing: 2,
                    ...
                    GestureDetector(
                      onTap: () => Navigator.pushReplacement(
                          context, _fade(const GameScreen())),
                      child: Container(
                        width: double.infinity,
                        height: 56,
                        decoration: BoxDecoration(
                    ...
                    GestureDetector(
                      onTap: () => Navigator.pushAndRemoveUntil(
                          context, _fade(const HomeScreen()), (_) => false),
                      child: Container(
                        width: double.infinity,
                        height: 50,
                        decoration: BoxDecoration(
  ...
  void _showReviveDialog(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Continue Mission?',
            style: TextStyle(
...
class _GameOverBgPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // NO blur — layered circles replace sigma-80 offscreen buffer
    final p = Paint();
    p.color = AppTheme.danger.o(0.015 + sin(t * 2 * pi) * 0.005);
    canvas.drawCircle(Offset(size.width * 0.8, size.height * 0.3), 280, p);
    p.color = AppTheme.danger.o(0.03 + sin(t * 2 * pi) * 0.01);
    canvas.drawCircle(Offset(size.width * 0.8, size.height * 0.3), 200, p);
    p.color = AppTheme.danger.o(0.04 + sin(t * 2 * pi) * 0.015);
    canvas.drawCircle(Offset(size.width * 0.8, size.height * 0.3), 120, p);
    p.color = AppTheme.purple.o(0.015);
    canvas.drawCircle(Offset(size.width * 0.2, size.height * 0.7), 230, p);
