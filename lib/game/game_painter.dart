...
class GamePainter extends CustomPainter {
  ...
  void _drawLaserWall(Canvas canvas, Size size, Obstacle obs) {
    ...
    if (tier == WallTier.standard) {
      ...
      // Plasma trench
      final innerRect = Rect.fromLTWH(rect.left, rect.top + rect.height * 0.3,
    ...
    if (tier == WallTier.reinforced) {
      ...
      final channelRect = Rect.fromLTWH(rect.left,
          rect.top + rect.height * 0.25, rect.width, rect.height * 0.5);
    ...
    if (tier == WallTier.armored) {
      ...
      for (int ch = 0; ch < 3; ch++) {
        ...
        final channelR = Rect.fromLTWH(rect.left,
            rect.top + rect.height * yFrac, rect.width, rect.height * 0.15);
